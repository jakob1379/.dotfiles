...
*** Sane defaults
    ...
    (setq-default indent-tabs-mode nil                        ;; go away, tabs - use spaces!
                  fill-column 90                            ;; set width for linebreaking (possibly deprecated)
                  )
    #+END_SRC
    ...
    (add-hook 'prog-mode-hook '(lambda () ;; enable a line to indicate max length
...
***** Company-quickhelp
      ...
      (use-package company-quickhelp          ; Documentation popups for Company
        :ensure t
        :defer t
        :hook (global-company . #'company-quickhelp-mode))
      #+END_SRC
...
**** Virtual environment
     ...
     ;;   :config (defun projectile-pyenv-mode-set ()
     ...
     #+BEGIN_SRC emacs-lisp
     ;; (defvar pyenv-current-version nil
     ;;   nil)

     ;; (defun pyenv-init() ;; Initialize pyenv's current version to the global one.
